            ...
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <div class="relative pt-4 progress-bar">
                  <div
                    class="overflow-hidden mb-4 text-xs flex rounded bg-gray-200 h-3 rounded-lg"
                  >
                    <div
              ...
              <button
                @click="$router.push({
                  name:'projects-id', params: {id:campaign.id},
                })"
                class="text-center button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold mt-5 px-6 py-2 text-lg rounded-full"
              >
                Fund Now
            </button>
            </div>
