        ...
        <header class="flex items-center">
            ...
            <div class="flex ml-auto" v-else>
              <div class="dropdown inline-block relative z-10">
                <button 
                class="bg-white text-grey-700 font-semibold py-4 px-6 rounded inline-flex items-center">
                   <img 
                ...
                <ul class="dropdown-menu absolute hidden text-grey-700 pt-1 shadow w-full -mt-2">
                  <li>
                    <nuxt-link
                    to="/dashboard"
                    class="bg-white hover:bg-grey-100 hover:text-orange-500 py-2 px-4 block whitespace-no-wrap">
                      My Dashboard
                    </nuxt-link>
                  </li>
                  <li>
                  ...
                  <li>
                    <a
                    @click="logout()"
                    class="cursor-pointer rounded-b bg-white hover:bg-grey-100 hover:text-orange-500 py-2 px-4 block whitespace-no-wrap">
                      Logout
                  </a>
                  </li>
                </ul>
